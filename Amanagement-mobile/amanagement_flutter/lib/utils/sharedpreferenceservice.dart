...
// import '.dart';  // Import your UserInfo class
// import 'client_info.dart';  // Import your ClientInfo class

class SharedPreferencesService {
  // Save user info and client info to SharedPreferences
  // Save user info and client info to SharedPreferences
  Future<void> saveUserDataToPrefs(
      String token, UserInfo userInfo, ClientInfo clientInfo) async {
    ...
    // Use jsonEncode to convert map to string q
